...
def main():
    parser = argparse.ArgumentParser(description="Query system functionality using ontology and SWRL with LLM")
    parser.add_argument("-o", "--ontology", required=True, help="Path to ontology TTL file")
    parser.add_argument("-s", "--swrl", required=True, help="Path to SWRL rules file (.swrl)")
    parser.add_argument("-q", "--question", required=True, help="Question about system functionality")
    args = parser.parse_args()

    answer = ask_question(args.ontology, args.swrl, args.question)
    print(f"Question:\n{args.question}\n")
    print("Answer:\n")
    print(answer)
